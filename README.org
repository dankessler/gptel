...
Includes access to Grok models using a SuperGrok or X Premium+ subscription. Register a backend with

#+begin_src emacs-lisp
(gptel-make-xai-oauth "xAI-sub") ;Any name of your choosing
#+end_src
