...
** Contents :toc:
  ...
  - [[#setup][Setup]]
    ...
    - [[#other-llm-backends][Other LLM backends]]
      ...
      - [[#novita-ai][Novita AI]]
      - [[#xai][xAI]]
      - [[#xai-supergrokx-premium-subscription][xAI (SuperGrok/X Premium subscription)]]
      - [[#aiml-api][AI/ML API]]
...
| xAI subscription     | SuperGrok/X Premium sub    |
...
Includes access to Grok via a SuperGrok or X Premium subscription that
includes Grok access.  Register a backend with

#+begin_src emacs-lisp
(gptel-make-xai-oauth "SuperGrok") ;Any name of your choosing
#+end_src

You will be prompted to log into xAI as required.  (You can also log in manually with =M-x gptel-xai-oauth-login=.)

Refer to the documentation of =gptel-make-xai-oauth= to set more parameters.
